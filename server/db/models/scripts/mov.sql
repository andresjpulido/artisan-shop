CREATE OR REPLACE PROCEDURE public.movement(IN requested_amount integer, IN idsize integer, IN idproducttype integer, IN idoperation integer, IN username character varying)
    LANGUAGE 'plpgsql'
