...
class Payslips {
  ...
  static getPayslips(req: Request, res: Response, next: NextFunction) {
    console.log("getPayslips")
    return payslip.findAll().then(payslips => res.status(200).send(payslips));
  }

  static getPayslipsByUserId(req: Request, res: Response, next: NextFunction) {
  ...
  static getPayslipsById_(req: Request, res: Response, next: NextFunction) {
  ...
  static readPayslip(req: Request, res: Response, next: NextFunction) {
