...
import { createProductType, updateProductType, readOneProductType, UPD_PRODUCTTYPE } from '../redux/actions/productTypeActions'
...
export default function ProductType() {
  ...
  const productType = useSelector(state => state.productTypeReducer.productType)
  ...
  const handleChange = (ev) => {
    ev.persist();
    dispatch({ type: UPD_PRODUCTTYPE, payload: { ...productType, [ev.target.name]: ev.target.value } })
  }
      ...
      <form>
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="name" name="name"
            value={productType.name} onChange={handleChange} />
        </div>
        <div className="form-group">
          <label>Description</label>
          <input type="text" className="form-control" id="description" name="description"
            value={productType.description} onChange={handleChange} />
        </div>
